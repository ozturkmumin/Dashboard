...
export default function App() {
  ...
  const handleButtonClick = () => {
    ...
    // FinanceFlow bileşenini çağır
    ReactDOM.render(
      <Financeflow />,
      document.getElementById("finance-flow-container")
    );
  };
        ...
        <div className="App mt-5">
          <div className="row">
            ...
            <div className="col-lg-6 p-4">
              ...
              <div className="mt-3 h2 fw-bold">Marketplace</div>
              <div className="row">
                <div className="col-lg-8">
                  <div className="d-flex gap-3 bg-light data-analytics special-rounded">
                    <div className="d-flex flex-column gap-3">
                      <div className="bg-light special-rounded d-flex flex-column p-4">
                        <p>
                          {" "}
                          Data Analytics <br />
                          Overwiev
